...
A direcão terá a responsabilidade de controlar a direção.
Ela oferece os seguintes atributos:
a) Valor de direção com valores possiveis: Norte, Sul, Leste e Oeste
b) Método girar a Direita => N, L, S, O
c) Método girar a Esquerda => N, O, S, L
